...
<body>
          ...
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" 
                ...
                <span class="hide-menu">Laporan Data Tugas</span>
              </a>
            </li>
            ...
            <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-end">
              ...
              <li class="nav-item dropdown">
                <a class="nav-link nav-icon-hover" href="javascript:void(0)" id="drop2" data-bs-toggle="dropdown"
                  aria-expanded="false">
                  <img src="/modern/src/assets/images/profile/user-2.jpg" alt="" width="35" height="35" class="rounded-circle">
                </a>
  ...
  <script src ="/modern/scr/assets/libs/jquery/dist/jquery.min.js"></script>
